...
public interface MyLangAST {
    ...
    public static record FunctionExpression(String optionalName, List<Token> parameters, Expression body)
    ...
    public static record IfExpression(Expression condition, Expression thenBranch, Expression elseBranch)
            implements Expression {
        public <T> T accept(ExpressionVisitor<T> visitor) {
    ...
    public static record BlockExpression(List<DeclarationOrStatement> statements, Expression returnValue)
            implements Expression {
        public <T> T accept(ExpressionVisitor<T> visitor) {
    ...
    public static record WhileYieldExpression(Expression condition, Expression body) implements Expression {
        public <T> T accept(ExpressionVisitor<T> visitor) {
    ...
    public static record ForYieldExpression(Token variable, Expression collection, Expression guard, Expression body)
            implements Expression {
        public <T> T accept(ExpressionVisitor<T> visitor) {
    ...
    public static record ForDoExpression(Token variable, Expression collection, Expression guard, Statement body)
            implements Expression {
        public <T> T accept(ExpressionVisitor<T> visitor) {
    ...
    public static record VariableDeclaration(Token Name, Expression initializer, boolean isReassignable)
    ...
    public static record FunctionDeclaration(Token Name, List<Token> parameters, Expression body)
            implements Declaration {
        public <T> T accept(DeclarationVisitor<T> visitor) {
    ...
    public static record ClassDeclaration(Token Name, List<Declaration> fieldsAndMethods, ClassConstructor constructor)
            implements Declaration {
        public <T> T accept(DeclarationVisitor<T> visitor) {
    ...
    public static record SetIndexStatement(Expression list, Expression index, Expression expression)
    ...
    public static record SetPropertyStatement(Expression target, Token name, Expression expression)
            implements Statement {
        public <T> T accept(StatementVisitor<T> visitor) {
    ...
    public static record ClassConstructor(Token keyword, List<Token> parameters, Expression body)
