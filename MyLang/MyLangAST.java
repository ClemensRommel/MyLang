...
public static record FunctionCall(Expression callee, List<Expression> arguments) implements Expression {
public <T> T accept(ExpressionVisitor<T> visitor) {
    return visitor.visitFunctionCall(this);
}}
public static record FunctionExpression(String optionalName, List<Token> parameters, Expression body) implements Expression {
public <T> T accept(ExpressionVisitor<T> visitor) {
...
public static record ForYieldExpression(Token variable, Expression collection, Expression guard, Expression body) implements Expression {
public <T> T accept(ExpressionVisitor<T> visitor) {
...
public static record FunctionDeclaration(Token Name, List<Token> parameters, Expression body) implements Declaration {
public <T> T accept(DeclarationVisitor<T> visitor) {
...
public static record ClassConstructor(Token keyword, List<Token> parameters, Expression body) implements Constructor {
public <T> T accept(ConstructorVisitor<T> visitor) {
